...
relevant data, and executes operations on these objects. The first
argument to gsim is the object containing simulations of
...
* If you copy a gsim container, its contents will not be
  ...
  `clone()`, as in `wells\_sims\_copy <- clone(wells\_sims)`.
